...
import { BottomSheetType, setBottomSheetType, setIsBottomSheetOpen } from '@redux/features/activeEntitiesSlice';
            ...
            toast.promise(
                new Promise(async (resolve, reject) => {
                    ...
                    try {
                        ...
                        // // Extracting text from the uploaded .txt file
                        // const textFileName = newName.replace(`.${extension}`, '.txt');
                        // const textFileUrl = `https://recontact-temp-recording-bucket.s3.amazonaws.com/extracted-text/${textFileName}`;
                        ...
                        // const contactObj = await convertIntoVCardForm(text)

                        // const promise1 = convertIntoVCardForm(JSON.stringify(contactObj));
                        // const promise2 = axios.post(
                        //     `${process.env.REACT_APP_BACKEND_API_BASE_URL}/store`,
                        //     {
                        //         ...contactObj,
                        //         contactText: convertContactToString(contactObj),
                        //         userId
                        //     });
