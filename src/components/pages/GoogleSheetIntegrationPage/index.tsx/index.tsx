...
import GoogleSheetIntegrationDashboard from '@components/organisms/GoogleSheetIntegrationDashboard';



const GoogleSheetIntegrationPage = () => {
    const dispatch: AppDispatch = useDispatch()

    useEffect(() => {
        pushEvent('UserPageView', { pageName: 'GoogleSheetIntegrationPage' })
        dispatch(setActiveRouteKey(ActiveRouteKey.GSHEET_INTEGRATION))
    })
    ...
    return (
        <BaseLayout
            ...
            center={<GoogleSheetIntegrationDashboard />}
        />
    );
}
