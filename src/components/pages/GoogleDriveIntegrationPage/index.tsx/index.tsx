...
import GoogleDriveIntegrationDashboard from '@components/organisms/GoogleDriveIntegrationDashboard';
...
const GoogleDriveIntegrationPage = () => {
    ...
    useEffect(() => {
        pushEvent('UserPageView', { pageName: 'GoogleDriveIntegrationPage' })
        dispatch(setActiveRouteKey(ActiveRouteKey.GDRIVE_INTEGRATION))
    })
    ...
    return (
        <BaseLayout
            ...
            center={<GoogleDriveIntegrationDashboard />}
        />
    );
}
